...
.wordcloud-card {
  ...
  border-radius: 18px;
  background:
    radial-gradient(circle at 15% 20%, rgba(66, 153, 225, 0.14), transparent 34%),
    radial-gradient(circle at 88% 80%, rgba(159, 122, 234, 0.14), transparent 38%),
    #fbfdff;
...
<ul class="portfolio-list">
  <li>
    ...
    <strong>ML Engineer</strong> ｜ 2026年8月〜9月（6週間）
  </li>

  <li>
    <span class="portfolio-item-title">株式会社レトリバ</span><br>
    <strong>Researcher</strong> ｜ 2026年2月〜3月（7週間）<br>
